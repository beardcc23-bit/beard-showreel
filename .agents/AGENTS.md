...
- **每週一 Skill 自動掃描與提報排程**：系統設定於每週一自動觸發全域與專案 Skill 資料庫掃描，整理出最新、可升級或適合專案的技能清單與優勢分析提出給 Beard 審閱。貫徹不自動安裝原則，待使用者回覆「執行/安裝」後方進行安裝更新。

- **每週一全球 AI 新聞與焦點事件自動週報**：系統設定於每週一自動搜尋全球最新 AI 技術新聞、模型發佈、開發者工具與產業熱點，自動格式化為『AI 小道消息 (5條)』與『本周焦點事件 (5條)』並發送給 Beard。
