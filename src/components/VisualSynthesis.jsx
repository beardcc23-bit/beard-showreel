...
const categories = [
  {
    ...
    items: [
      ...
      { name: '可口可樂', domain: 'cocacola.com', videoId: '1286974884802497', isFacebook: true, bgImage: '/bg_a04.png' },
      { name: '好侍咖哩', domain: 'housefoods-group.com', videoId: 'jScTOFsO97U', bgImage: '/bg_a05.png' },
      { name: '伯朗EX雙倍濃烈咖啡', domain: 'mrbrown.com.tw', videoId: 'UmoyLNbcevQ', bgImage: '/bg_a06.png' },
      { name: '每朝双纖綠茶', domain: 'vitalon.com.tw', videoId: 'w1EUT4JnHck', bgImage: '/bg_a07.png' },
      { name: '每朝健康', domain: 'vitalon.com.tw', videoId: '_xC48BnWOAQ', bgImage: '/bg_a08.png' },
      { name: '噶瑪蘭威士忌', domain: 'kavalanwhisky.com' },
      { name: '柏克金啤酒', domain: 'buckskin.com.tw', videoId: 'aKYv6_VMPFI', bgImage: '/bg_a10.png' },
      { name: '金門高粱千日醇', domain: 'kkl.com.tw', videoId: '8rl7u3SPQpY', bgImage: '/bg_a11.png' },
      { name: '旨醞鐵板燒', domain: 'feastogether.com.tw', videoId: '2203781970428596', isFacebook: true, bgImage: '/bg_a12.png' },
      { name: '活沛多', domain: 'watsons.com.tw', videoId: 'Y4CG2QNa5hs', bgImage: '/bg_a13.png' },
      { name: '格蘭利威', domain: 'theglenlivet.com' },
      { name: '桂格喝的燕麥', domain: 'quaker.com.tw' },
      { name: '桂格', domain: 'quaker.com.tw', videoId: 'lxRJO_qPcWQ', bgImage: '/bg_a16.png' },
      { name: '泰山八寶粥', domain: 'taisungroup.com.tw', videoId: 'ry5k_i-XhVE', bgImage: '/bg_a17.png' },
      { name: '健酪乳酸飲料', domain: 'kingcar.com.tw', videoId: 'qJqmBWZxbdo', bgImage: '/bg_a18.png' },
      { name: '黑松茶花', domain: 'heysong.com.tw', videoId: 'TRqUVCCZwRU', bgImage: '/bg_a19.png' },
      { name: '黑松茶花', domain: 'heysong.com.tw', videoId: 'cKbH-CxdjxY', bgImage: '/bg_a20.png' },
      { name: '瑞穗鮮乳', domain: 'uni-president.com.tw', videoId: 'owT3Sj_So60', bgImage: '/bg_a21.png' },
      { name: '義美生機', domain: 'imeieco.com', videoId: 'kakD_HQkIQU', bgImage: '/bg_a22.png' },
      { name: '裸雀威士忌', domain: 'nakedmalt.com' },
      { name: '維他露P+', domain: 'vitalon.com.tw', videoId: 'AyQQZ37OPfU', bgImage: '/bg_a24.png' },
      { name: '樂事', domain: 'lays.com', videoId: 'zQfi9U_023I', bgImage: '/bg_a25.png' },
