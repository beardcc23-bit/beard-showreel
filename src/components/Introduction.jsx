        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="md:col-span-7 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <motion.h2
              ...
              className="text-[48px] sm:text-6xl md:text-7xl font-black tracking-tighter mb-8 leading-none glow-title whitespace-nowrap w-full flex justify-center md:justify-start"
            >
