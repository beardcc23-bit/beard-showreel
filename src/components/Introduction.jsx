      ...
      <div className="max-w-6xl mx-auto px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 lg:gap-16 xl:gap-20 items-center">
          ...
          <div className="md:col-span-7 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            >
              <RefractionCard
                className="flex justify-around w-full py-6 px-2 md:px-8 text-center backdrop-blur-none md:backdrop-blur-sm border border-white/[0.1] rounded-[24px] shadow-2xl relative overflow-hidden group"
                style={{
