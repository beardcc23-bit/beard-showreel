      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
          ...
          <div className="md:col-span-6 space-y-8 text-zinc-350 text-base md:text-lg leading-relaxed font-light">
            <p>
              作為台灣俗稱的 D1 技師，我接手廣告製作的最後一步。從前期創意發想、實際拍攝、Offline 剪接再到調光，最後檔案來到我手上開始 Online。依需求進行人物膚質精修、場景穿幫、綠幕去背、場景合成與字幕效果。在反覆經由導演、代理商確認並與客戶實際交片後，最後製作SC播帶，完成這次製作。
            </p>
                ...
                return (
                  ...
                  >
                    <span className={`text-[6px] mono tracking-widest uppercase mb-1 ${
                      activeTab === cat.id ? 'text-black/80' : 'text-zinc-500'
                    }`}>{label.eng}</span>
