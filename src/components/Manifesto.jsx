...
export default function Manifesto({ onPlayVideo }) {
  ...
  return (
    <section id="about" className="w-full relative py-36">
      {/* 滿版網格與漸層裝飾背景 */}
      ...
      <div className="max-w-6xl mx-auto px-8 relative z-10">
        ...
        <div className="text-center mb-16 relative z-10 w-full">
          <h2 className="text-[clamp(2.4rem,11vw,9.5rem)] font-black tracking-[-0.04em] uppercase mb-6 glow-title text-white whitespace-nowrap leading-none w-full flex justify-between sm:justify-center items-center">
            <span>THE</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 lg:gap-16 items-start">
              ...
              <p>
                  ...
                  onClick={() => {
                    ...
                    if (window.innerWidth < 768) {
                      window.dispatchEvent(new CustomEvent('open-image-modal', {
                        detail: {
                          imageUrl: `${import.meta.env.BASE_URL}f1.webp`,
                ...
                >
                  ...
                  <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-4 w-[290px] md:w-[350px] pointer-events-none opacity-0 translate-y-3 scale-95 group-hover/flame:opacity-100 group-hover/flame:translate-y-0 group-hover/flame:scale-100 transition-all duration-500 ease-out z-[99] hidden md:block">
                    <span className="block bg-zinc-950/95 border border-white/10 rounded-[12px] p-3.5 shadow-[0_30px_60px_rgba(0,0,0,0.9),_0_0_30px_rgba(212,175,55,0.12)] relative overflow-hidden">
                      {/* 寫實高透玻璃反光 */}
                      ...
                      <span className="block relative aspect-video overflow-hidden border border-zinc-900 rounded-sm mb-3">
                        <img
                          src={`${import.meta.env.BASE_URL}f1.webp`}
          ...
          <div className="md:col-span-6 flex flex-col">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <RefractionCard 
                  className="backdrop-blur-none md:backdrop-blur-sm border border-white/[0.1] rounded-[32px] p-6 md:p-8 shadow-2xl relative overflow-hidden group"
                  style={{
                      ...
                      {activeCategory.params.map((param) => {
                        ...
                        return (
                          <div key={param.key} className="space-y-1.5 pb-3.5 border-b border-zinc-900 last:border-b-0 last:pb-0">
                            ...
                            >
                              <Play size={10} fill="currentColor" className="text-aurora-blue play-triangle-pulse group-hover/title:!scale-150 transition-transform duration-200" />
